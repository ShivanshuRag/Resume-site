...
const About = () => {
  return (
    <div className="container mx-auto my-auto p-16 flex flex-col md:flex-row-reverse items-center justify-between">
      {/* Moved Image and Icons to the left */}
      <div className="md:w-1/2 flex flex-col justify-center items-center">
        <img
          src={profileImage}
          alt="Shivanshu Singh"
          className="w-48 h-48 rounded-md object-cover shadow-lg mb-4"
          style={{
